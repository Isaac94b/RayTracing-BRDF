...
class Sphere : public Object {
	...
	Sphere(Vect, double, Color,  Color, Color);
...
Sphere::Sphere (Vect centerValue, double radiusValue, Color AmbientIntensityValue, Color DiffuseIntensityValue, Color SpecularIntensityValue){
